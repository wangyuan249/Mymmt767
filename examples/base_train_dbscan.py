...
def main_worker(args):
    ...
    for epoch in range(args.epochs):
        dict_f, _, _ = extract_features(model, tar_cluster_loader, print_freq=50)
...
if __name__ == '__main__':
    ...
    # training configs
    parser.add_argument('--init', type=str, default='logs/duke/resnet50-pretrain-4/model_best.pth.tar', metavar='PATH')
