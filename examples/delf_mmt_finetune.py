...
def main_worker(args):
    ...
    for epoch in range(args.epochs):
        ...
        cf_select1 = torch.stack(list(featureSelect.values())).numpy()
        # pdb.set_trace()
        # for key, value in att_score1.values():
        #     print(key)
        #     print(value.shape)


        # print("dict_f", dict_f.shape)
        # print("origin_fea1",origin_fea1.shape)
        # print("att_score1", att_score1.shape)  # 8, 1, 16, 8
        ...
        cf_select = (cf_select1 +cf_select2) / 2
...
if __name__ == '__main__':
    ...
    parser.add_argument('--init-1', type=str,
                        default='logs/duke/resnet50-pretrain-4/model_best.pth.tar', metavar='PATH')
    parser.add_argument('--init-2', type=str,
                        default='logs/duke/resnet50-pretrain-5/model_best.pth.tar', metavar='PATH')
